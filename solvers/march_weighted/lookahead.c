...
#ifdef WEIGHTED
        diffScore *= var_weight[varnr];
#endif


//		printf("c var %i with score %.2f and weight %.2f \n", varnr, diffScore, var_weight[varnr]);
...
#endif
        num_decisions++;
        //printf("c var %i with score %.2f and weight %.2f \n", maxDiffVar * maxDiffSide, maxDiffScore, var_weight[maxDiffVar]);
